<template>
    <div class="flex justify-between transition duration-500 dark:bg-gray-900 bg-white w-full z-50 items-center h-16 px-8 lg:fixed lg:bg-opacity-50 dark:lg:bg-opacity-25 lg:border-b border-green-500 border-opacity-5">
